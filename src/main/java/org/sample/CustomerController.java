...
public class CustomerController {
   ...
   @Operation(
         summary = "load autogenerated schema schema in java code",
         description = "Load protobuf schema")
   public String loadSchema() {

      Cache protobufMetadata = cacheManager.getCache("___protobuf_metadata");

      GeneratedSchema schema = new CustomerSchemaBuilderImpl();

      // Define the new schema on the server too
      protobufMetadata.put(schema.getProtoFileName(), schema.getProtoFile()); //(3)
